...
def binary_place_value_lesson() -> rx.Component:
    ...
    return rx.box(
        rx.vstack(
            ...
            _section(
                "6",
                "Use the real BoolNexa laboratory",
                rx.text(
                    "Now repeat the same place-value reasoning with the autonomous "
                    "Number System Laboratory. Try several binary and decimal values "
                    "and compare its worked conversion steps with your own calculation.",
                    color="#475569",
                    line_height="1.65",
                ),
                rx.link(
                    rx.button(
                        "Open Number System Laboratory",
                        color_scheme="blue",
                        size="3",
                    ),
            ...
            rx.hstack(
                ...
                rx.spacer(),
                rx.text("Unit 1 · Lesson 2 of 10", size="2", color="#64748b"),
                rx.spacer(),
                rx.link(
