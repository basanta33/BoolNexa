"""Central SEO metadata and structured data for BoolNexa."""
...
PAGE_URL = f"{SITE_URL}/"
SOCIAL_IMAGE_URL = f"{SITE_URL}/og-image.png"
...
def seo_head_components() -> list[rx.Component]:
    """Return canonical, branding, and structured-data head elements."""
    return [
...
def seo_meta() -> list[dict[str, str]]:
    """Return page-level search, Open Graph, and Twitter/X metadata."""
    return [
        ...
        {"property": "og:image:alt", "content": "BoolNexa digital logic simulator"},
        {"property": "og:locale", "content": "en_US"},
        {"name": "twitter:card", "content": "summary_large_image"},
        {"name": "twitter:title", "content": PAGE_TITLE},
        {"name": "twitter:description", "content": SOCIAL_DESCRIPTION},
        {"name": "twitter:image", "content": SOCIAL_IMAGE_URL},
        {"name": "twitter:image:alt", "content": "BoolNexa digital logic simulator"},
    ]
